  ...
  return (
      <React.Fragment>
        ...
        <Typography  style={{ padding: 10 }} variant="h6" gutterBottom>
          ...
          <Grid style={{ width: 500,marginLeft:40,paddingBottom:30 }} container spacing={3}>
        ...
        <Button style={{marginTop:15,marginLeft:80}} variant="outlined" color="primary">
        Send Question
        </Button>
        </Grid>
          ...
          <Paper style={{ width:300,marginTop:70}}>
            <h3 style={{ marginTop: 50,padding: 10 , fontSize:20 }}>Most Frequently Questions</h3>
          </Paper>
        ...
        <Card className={classes.card}>
          <div className={classes.cardDetails}>
            <CardContent>
              ...
              <Typography variant="subtitle1">
                <span style={{color:'#50CB93'}}> Answer:</span> <br />  
                you can find your report at <a style={{color:'#284E78',fontWeight:'bold' ,textDecoration:'underline'}} href="/Report">Report</a> Page
              </Typography>
            </CardContent>
          </div>
          <Hidden xsDown>
